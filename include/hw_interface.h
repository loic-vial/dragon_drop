...
ei_surface_t hw_create_window(ei_size_t * size,
			      const ei_bool_t fullScreen);
...
/** 
 * @brief	Sets the coordinates of the first pixel of the surface.
...
/** 
 * @brief	Returns a pointer to the address of the first pixel of a surface.
 *		This is the top-left pixel of the surface: pixels are ordered by horizontal lines,
...
void hw_text_compute_size(const char *text,
			  const ei_font_t font, int *width, int *height);
