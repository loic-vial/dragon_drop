...
#include "ei_tag.h"
/**
* \brief A type of widget wich represent a frame
*
*/
...
/**
 * @brief Allocates a block in the memory the size of a \ref ei_frame_t, initialized to zero
 * @return                      Returns a pointer to a frame
 */
void *ei_frame_allocfunc();

/**
 * @brief Releases all parameters of a frame
...
/**
 * @brief Sets default all attributes of a frame
 * @param widget                        The frame widget to set to defaults values
 */
void ei_frame_setdefaultsfunc(ei_widget_t * widget);

/**
 * @brief Creates a list a point in a circle, and only a part of this circle is returned
