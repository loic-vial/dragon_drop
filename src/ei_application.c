...
void ei_app_create(ei_size_t * main_window_size, ei_bool_t fullscreen)
{
	...
	offscreen_surface =
	    hw_surface_create(root_surface, main_window_size, EI_FALSE);
	...
	ei_frame_configure(&root->widget, main_window_size, &color, NULL,
			   NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	ei_place(&root->widget, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
		 NULL, NULL);
