...
ei_rect_t rectangle_intersection(ei_rect_t rect1, ei_rect_t rect2)
{
    ...
    int mindroit = min(rect1.top_left.x + rect1.size.width, rect2.top_left.x + rect2.size.width);
    int maxbas = max(rect1.top_left.y, rect2.top_left.y);
    int minhaut = min(rect1.top_left.y + rect1.size.height, rect2.top_left.y + rect2.size.height);
