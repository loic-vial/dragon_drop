...
ei_bool_t display(ei_widget_t * widget, ei_event_t * event,
		  void *user_param)
{
	...
	if (widget_has_this_tag(widget, "tooltip")) {
		...
		location.y += 200;
		ei_place(frame_tooltip, NULL, &location.x, &location.y,
...
ei_bool_t activation(ei_widget_t * widget, ei_event_t * event,
		     void *user_param)
{
...
ei_bool_t positif(ei_widget_t * widget, ei_event_t * event,
		  void *user_param)
{
...
ei_bool_t negatif(ei_widget_t * widget, ei_event_t * event,
		  void *user_param)
{
...
ei_bool_t desactivation(ei_widget_t * widget, ei_event_t * event,
			void *user_param)
{
...
int ei_main(int argc, char **argv)
{
	...
	ei_place(frame, &anc, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
		 NULL);
	...
	/*Create a button */
	ei_widget_t *button1 =
	    ei_widget_create("button", ei_app_root_widget());
	text = "Ce bouton désactive la tooltip";
	ei_font_t font =
	    hw_text_font_create("misc/font.ttf", ei_style_normal, 13);
	...
	ei_button_configure(button1, &button_size, &button_color, &button_border_width, NULL, &button_relief, &text, &font, NULL, NULL, NULL, NULL, NULL, &desactivation_callback, NULL);	//il faut mettre la callback
	anc = ei_anc_northwest;
	int x = 10;
	int y = 50;
	ei_place(button1, &anc, &x, &y, NULL, NULL, NULL, NULL, NULL,
		 NULL);
	...
	ei_button_configure(button2, &button_size, &button_color, &button_border_width, NULL, &button_relief, &text, &font, NULL, NULL, NULL, NULL, NULL, &activation_callback, NULL);	//il faut mettre la callback
	anc = ei_anc_southwest;
	int x2 = 10;
	int y2 = -50;
	ei_place(button2, &anc, &x2, &y2, NULL, NULL, NULL, NULL, NULL,
		 NULL);
	...
	ei_button_configure(button3, &button_size, &button_color, &button_border_width, NULL, &button_relief, &text, &font, NULL, NULL, NULL, NULL, NULL, &positif_callback, NULL);	//il faut mettre la callback
	anc = ei_anc_northeast;
	int x3 = -10;
	int y3 = 50;
	ei_place(button3, &anc, &x3, &y3, NULL, NULL, NULL, NULL, NULL,
		 NULL);
	...
	ei_button_configure(button4, &button_size, &button_color, &button_border_width, NULL, &button_relief, &text, &font, NULL, NULL, NULL, NULL, NULL, &negatif_callback, NULL);	//il faut mettre la callback
	anc = ei_anc_southeast;
	int x4 = -10;
	int y4 = -50;
	ei_place(button4, &anc, &x4, &y4, NULL, NULL, NULL, NULL, NULL,
		 NULL);
	...
	printf
	    ("On affiche la liste initiale de tags dans l'application' \n");
	display_list_tag();
