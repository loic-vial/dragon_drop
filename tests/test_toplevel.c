...
ei_bool_t ei_quit(ei_widget_t * widget, ei_event_t * event,
		  void *user_param)
{
...
void create_root()
{
	...
	ei_frame_configure(ei_app_root_widget(), NULL, &root_color, NULL,
...
void create_toplevel_1()
{
	ei_widget_t *toplevel =
	    ei_widget_create("toplevel", ei_app_root_widget());
	...
	ei_toplevel_configure(toplevel, &toplevel_size, &toplevel_color,
			      &toplevel_border, &toplevel_text,
			      &toplevel_closable, &toplevel_resizable,
			      NULL);
	ei_place(toplevel, NULL, &toplevel_x, &toplevel_y, NULL, NULL,
		 NULL, NULL, NULL, NULL);
	...
	ei_banner_configure(toplevel, &color_banner, &color_text,
	...
	ei_frame_configure(frame, NULL, &frame_color, NULL, NULL,
			   &frame_text, NULL, &frame_text_color, NULL,
			   NULL, NULL, NULL);
	ei_place(frame, &frame_anchor, NULL, NULL, NULL, NULL, NULL, NULL,
		 NULL, NULL);
}
...
ei_widget_t *create_toplevel_2()
{
	...
	ei_toplevel_configure(toplevel, &toplevel_size, NULL, NULL,
			      &toplevel_text, &toplevel_closable,
	...
	ei_place(frame, &frame_anchor, NULL, &y, NULL, NULL, NULL, NULL,
		 NULL, NULL);
...
void create_toplevel_3()
{
	...
	ei_frame_configure(frame, NULL, NULL, NULL, NULL, &frame_text,
			   NULL, NULL, NULL, NULL, NULL, NULL);
	ei_place(frame, &frame_anchor, &x, &y, NULL, NULL, NULL, NULL,
		 NULL, NULL);
	...
	ei_frame_configure(frame2, NULL, NULL, NULL, NULL, &frame2_text,
			   NULL, NULL, NULL, NULL, NULL, NULL);
	ei_place(frame2, &frame2_anchor, &x, &y, NULL, NULL, NULL, NULL,
		 NULL, NULL);
}
...
void create_toplevel_4()
{
	...
	ei_widget_t *child_toplevel =
	    ei_widget_create("toplevel", toplevel);
	...
	ei_toplevel_configure(child_toplevel, &ttoplevel_size,
			      &ttoplevel_color, NULL, &ttoplevel_text,
			      NULL, NULL, &ttoplevel_min_size);
	ei_place(child_toplevel, NULL, &ttoplevel_x, &ttoplevel_y, NULL,
		 NULL, NULL, NULL, NULL, NULL);

	ei_widget_t *child_frame =
	    ei_widget_create("frame", child_toplevel);
	...
	ei_surface_t child_frame_img =
	    hw_image_load("misc/yinyang.png", ei_app_root_surface());
	ei_frame_configure(child_frame, &child_frame_size,
			   &child_frame_color, NULL, NULL, NULL, NULL,
			   NULL, NULL, &child_frame_img, NULL, NULL);
	ei_place(child_frame, &child_frame_anchor, NULL, NULL, NULL, NULL,
		 NULL, NULL, NULL, NULL);

	ei_widget_t *child_toplevel_2 =
	    ei_widget_create("toplevel", child_toplevel);
	...
	ei_toplevel_configure(child_toplevel_2, &tttoplevel_size,
			      &tttoplevel_color, NULL, &tttoplevel_text,
			      NULL, NULL, &tttoplevel_min_size);
	ei_place(child_toplevel_2, NULL, &tttoplevel_x, &tttoplevel_y,
		 NULL, NULL, NULL, NULL, NULL, NULL);
...
ei_bool_t click_callback(ei_widget_t * widget, ei_event_t * event,
			 void *user_param)
{
	ei_widget_t *frame = (ei_widget_t *) user_param;
	sprintf(buffer, "%d", ++current_click_nb);
	char *text = buffer;
	ei_frame_configure(frame, NULL, NULL, NULL, NULL, &text, NULL,
			   NULL, NULL, NULL, NULL, NULL);
...
void create_toplevel_5()
{
	...
	ei_button_configure(button, NULL, NULL, NULL, NULL, NULL,
			    &button_text, NULL, NULL, NULL, NULL, NULL,
			    NULL, &click_cb, (void **) &frame);
	ei_place(button, &button_anchor, NULL, NULL, NULL, NULL, NULL,
		 NULL, NULL, NULL);
}
